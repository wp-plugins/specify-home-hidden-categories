...
Contributors: yzhs
Tags:  SHHC,Specify,exclude,hide,related,HiddenCategories,Specify Home Hidden,categories,Cat,options,Homepage,Home,feed,rss,get_posts,have_posts,the_post,Hidden,page,post,Posts,All
...
== Description ==
English: Plugin help hide all posts in one or more category on Homepage. Go to \"Settings» Reading \"to choose the category need to hide
...
中文：[Specify Home Hidden Categories常见问题回答](http://www.9sep.org/specify-home-hidden-categories#comments)
